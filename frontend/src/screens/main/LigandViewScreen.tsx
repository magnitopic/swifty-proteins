      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="flex flex-row justify-center absolute bottom-40 gap-3 right-0 left-0">
          <TouchableOpacity className="border border-gray-400 bg-gray-100 p-1 px-2 rounded-full items-center justify-center">
            <Text className="text-gray-400 font-medium text-md">Model 1</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-gray-400 bg-gray-100 p-1 px-2 rounded-full items-center justify-center">
            <Text className="text-gray-400 font-medium text-md">Model 2</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-gray-400 bg-gray-100 p-1 px-2 rounded-full items-center justify-center">
            <Text className="text-gray-400 font-medium text-md">Model 3</Text>
          </TouchableOpacity>
        </View>
